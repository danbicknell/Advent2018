...
*/
    ...
    val three = new Three
    val result3a = three.findOverlappingFabric
    println("The answer to Puzzle 3-A is: " + result3a)
    val result3b = three.findValidClaim
    println("The answer to Puzzle 3-B is: " + result3b)
